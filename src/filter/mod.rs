...
//!
//! This module contains the log filtering used by `ic_log` to match records.
//! You can use the `Filter` type in your own logger implementation to use the same
//! filter parsing and matching as `ic_log`. For more details about the format
//! for directive strings see [Enabling Logging].
//!
//! ## Using `ic_log` in your own logger
//!
//! You can use `ic_log`'s filtering functionality with your own logger.
